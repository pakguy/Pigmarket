"""
Django settings for PigRecord project.
...
SECRET_KEY = 'django-insecure-^exfjc8l=lm5$*okm-hh6(3^1973(%&l(r326t8k8s$j!-&44v'
...
WSGI_APPLICATION = 'PigRecord.wsgi.application'
